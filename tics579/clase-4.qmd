...
> Pytorch necesita crear una clase que herede de `Dataset` y que  permita tomar elementos uno a uno y transformarlos en Tensores. Este clase debe tener al menos 3 métodos: `\_\_init\_\_`, `\_\_len\_\_` y `\_\_getitem\_\_`.
