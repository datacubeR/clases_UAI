...
## Nota Final
$$NP = 0.4 \cdot MT + 0.6 \cdot FE$$
$$NF = NP \cdot 0.9 + 0.1\cdot \overline{NT}$$
:::

::: {.callout-note appearance="default"}
## Pruebas

**MT: Midterm**: Prueba a mitad del Curso el cuál vale un 40% de la Nota de Pruebas (NP).

**Final Exam**: 60% de la Nota de Pruebas, considera todo el contenido del curso.

$\overline{NT}$: Corresponde al promedio de Tareas. 

Tanto NP, como NT deben ser mayor o igual a 4.0. En caso contrario se reprueba el curso con la nota más desfavorable.
:::
