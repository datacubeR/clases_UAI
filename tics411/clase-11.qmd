...
subtitle: "Clase 11: Árboles de Decisión"
...
![](img/clase-11/dt.png){.lightbox fig-align="center"}
...
::: {.columns}
::: {.column width="40%"}
![](img/clase-11/dt_problem.png){.lightbox fig-align="center"}
:::
::: {.column width="60%" .fragment}

![](img/clase-11/dt_solution.png){.lightbox fig-align="center"}
:::
::: 
...
:::
::: {.column width="60%"}
![](img/clase-11/dt_viz.png){.lightbox fig-align="center"} 
:::
::: 
...
:::
::: {.column width="30%"}
![](img/clase-11/dt_clf.png){.lightbox fig-align="center"} 
:::
::: 
...
![**Binary Split**](img/clase-11/binary_trees.png){.lightbox fig-align="center"}
:::
::: {.column}
![**Multi-way Split**](img/clase-11/multiple_trees.png){.lightbox fig-align="center"}
:::
::: 
...
El árbol de Decisión busca crear Nodos los más puro posible. Para ello puede utilizar las siguentes métricas: 
:::
...
![](img/clase-11/data_avengers.png){.lightbox fig-align="center"} 
...
## Árbol de Decisión: Definición de Nodo Raíz {.smaller}
...
:::
::: {.column width="60%"}
![](img/clase-11/popcorn_root.png){.lightbox fig-align="center"} 

$$Gini_{(yes)} = 1 - (\frac{1}{4})^2 - (\frac{3}{4})^2 = 0.375$$
$$Gini_{(no)} = 1 - (\frac{2}{3})^2 - (\frac{1}{3})^2 = 0.444$$
...
:::
::: {.column width="60%"}
![](img/clase-11/soda_root.png){.lightbox fig-align="center"} 
...
::: {.columns}
::: {.column width="40%"}
![](img/clase-11/cont_splits.png){.lightbox fig-align="center"} 
...
:::
::: {.column width="60%"}
![](img/clase-11/age_9.5.png){.lightbox fig-align="center"} 
...
:::
::: {.column width="60%"}
![](img/clase-11/age_15.png){.lightbox fig-align="center"} 
...
:::
::: {.column width="60%"}
![](img/clase-11/age_26.5.png){.lightbox fig-align="center"} 
...
:::
::: {.column width="60%"}
![](img/clase-11/age_36.5.png){.lightbox fig-align="center"} 
...
:::
::: {.column width="60%"}
![](img/clase-11/age_44.png){.lightbox fig-align="center"} 
...
:::
::: {.column width="60%"}
![](img/clase-11/age_66.5.png){.lightbox fig-align="center"} 
...
::: {.columns}
::: {.column width="30%"}
![](img/clase-11/gini_iter1.png){.lightbox fig-align="center" width="50%"} 
:::
::: {.column width="70%"}
![](img/clase-11/soda_root.png){.lightbox fig-align="center" width="50%"} 

![](img/clase-11/split_2.png){.lightbox fig-align="center" width="50%"} 
:::
::: 
...
::: {.columns}
::: {.column }
![](img/clase-11/split_2.png){.lightbox fig-align="center"} 

:::
::: {.column }
![](img/clase-11/popcorn_2.png){.lightbox fig-align="center"} 
...
:::
::: {.column }
![](img/clase-11/age_12.5_2.png){.lightbox fig-align="center"} 
...
:::
::: {.column }
![](img/clase-11/age_26.5_2.png){.lightbox fig-align="center"} 
...
:::
::: {.column }
![](img/clase-11/age_36.5_2.png){.lightbox fig-align="center"} 
...
::: {.columns}
::: {.column width="30%"}
![](img/clase-11/gini_2.png){.lightbox fig-align="center"} 
:::
::: {.column width="70%" .fragment fragment-index=1}
![](img/clase-11/arbol_final.png){.lightbox fig-align="center"} 

::: {.callout-note .fragment fragment-index=2}
***¿Cuál sería la predicción?***
:::

![](img/clase-11/pred.png){.lightbox fig-align="center" .fragment fragment-index=2} 
:::
::: 

## Crecimiento de un Árbol

* Un árbol sólo parará de crecer si:
...
## Permite Visualizar el Árbol de 
plt_tree(dt, filled = True, impurity=True, node_ids = )
